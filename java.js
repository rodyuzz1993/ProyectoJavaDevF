...
document.getElementById("saldoDepositar").innerHTML = ingresoPermitido;
document.getElementById("saldoRetirar").innerHTML = retiroPermitido;

//********** PARA INGRESAR DEBEMOS TENER USUARIO Y PASSWORD CORRECTAMENTE **********

//PARA INGRESAR DEBEMOS TENER USUARIO Y PASSWORD CORRECTAMENTE
//CICLO WHILE PARA TERMINAR O CONTINUAR PREGUNTANDO POR EL USUARIO Y CONTRASEÑA
...
do{
    ...
    if(pregunta=="SI")
        {
           do{
            ...
            var dineroRetiro = document.getElementById("cantidadRetiro").value;
 ...
 function funcionIngreso(){
    ...
    if(pregunta=="SI")
    {
        ...
        var dineroIngreso = document.getElementById("cantidadDeposito").value;
...
do{   
    ...
    if(cuentas[i].usuario == usuarioingreso && cuentas[i].password == passwordingreso){
...
}while(cuentas[i].usuario != usuarioingreso || cuentas[i].password != passwordingreso)
*/